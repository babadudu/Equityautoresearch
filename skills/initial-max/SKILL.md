...
| DCF / 投資論文 | 5 | **WACC 分解**（Rf + ERP × β + 台灣地緣溢價，逐項列出）+ 三情境表 + IRR 拆分（成長+估值+回購）+ **3×3 敏感度矩陣**（營收成長 vs WACC）；缺 WACC 分解或敏感度矩陣者不得滿分 |
...
| 正反論辯 | 15 | 8.1 Bull Case(5) + 8.2 Bear Case(5) + 8.3 數據對比(5) |

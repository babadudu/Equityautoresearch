...
| 6.3 衝突概率+SMIC追趕+中國EUV時間軸+ASML斷供+出口管制量化 | 15 | 15 | 衝突概率6來源+**3層級衝突GDP量化**（$2,000億/$5.3T/$10.6T, Insurance Journal 2026）+**產業鏈連鎖效應**（手機-80%/汽車-30~50%/航運$2.45T）+**複合風險迴路**（成長→脆弱性→地緣風險自我強化）+SMIC 6指標+中國LDP-EUV 4里程碑表+CSIS/EE Times技術評估+3時間範圍威脅等級表+**ASML EUV斷供4階段模型**（kill switch+6月維護週期+備件緩衝→12-18月崩潰）+**出口管制最壞情境**（7nm禁令毛利稀釋-0.8~1.2pp，全面禁令-2~3pp）+台灣民主治理護城河分析 |

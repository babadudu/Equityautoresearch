...
| 生意 | 33 | 35 | 2.2/2.3 商業模式含≥25 則 CEO 引言+晶圓定價+收入拆分+AI CAGR 54-56%；五力≥5 則/力；DCF 完整+多指標估值（P/E+EV/EBITDA+P/FCF）+WACC 分解+3×3 敏感度矩陣 |
| 組織 | 18 | 20 | 3.1 文化+誠信治理（Chang 誠信3則+公司治理評鑑11年+員工77K合規訓練）；1.4 地理七年趨勢+絕對營收+**20-F SEC EDGAR 連結** |
| 人 | 27.5 | 30 | Chang 誠信底線+Wei 格局觀擴充；**繼任風險**：Wei 年齡72-73歲明確標示+雙Co-COO（Y.J. Mii/Y.P. Chyn）+Kevin Zhang/Cliff Hou副手+板凳深度中高+4位SVP離任分析；訪談 40/25 篇+**逐字稿 28 篇** |
| **四維合計** | **96** | **105** | 含延伸維度（六七八章）總分 170/180，詳見第五節評分表 |
...
| 多指標估值與 DCF | 5 | 5 | **≥3 種估值方法**（P/E+EV/EBITDA+P/FCF）三角交叉驗證+同業5家對比表+EV/EBITDA 5年歷年走勢+公允價值區間匯總+WACC 分解（Rf 4.3%+ERP×β+地緣溢價=9%）+3×3 敏感度矩陣（營收成長 vs WACC）+P/E 敏感度+IRR 拆分+完整三表+情境分析+營收拆解 |
| **小計** | **33** | **35** | |
...
| 評分項目 | 得分 | 滿分 | 說明 |
|----------|------|------|------|
| 地理/業務分部收入 | 7.5 | 8 | 七年地理趨勢表（2018-2024）含NT$絕對值+佔比+區域CAGR+平台+製程三維+日本獨立列出+**20-F SEC EDGAR 可點擊連結**（[sec.gov](https://www.sec.gov/Archives/edgar/data/1046179/000104617925000037/tsm_20250417.htm)） |
...
| 繼任風險與板凳深度 | 4.5 | 5 | **Wei 年齡 72-73 歲+任期 28 年明確標示**；≥2 位次世代領導人：**Y.J. Mii**（EVP Co-COO，UCLA PhD，IEEE 獎，R&D 路線，31 年）+ **Y.P. Chyn**（EVP Co-COO，創辦元老 39 年，Operations 路線）+ Kevin Zhang（SVP Deputy Co-COO，ex-Intel Fellow）+ Cliff Hou（SVP Deputy Co-COO）；板凳深度評級：**中高**（雙 Co-COO 結構鏡像 2012 年 Wei/Liu 模式+4 位離任高管之補位完成+風險：4 位 SVP 2025 年同期退休+Wei 兼任雙職交班未公開）；繼任計畫揭露：Bloomberg/SCMP 解讀為「succession move」 |
| 道德操守與價值創造驅動力 | 4.5 | 5 | Chang 誠信3則（2005 遠見）：top-down integrity/親自要求辭職/TSMC為「淨土」+Wei 誠信承諾（2024）+公司治理11年top 5%+77K員工合規+Ombudsmen制度 |
| 公開訪談 ≥25 篇 + 逐字稿已下載 | 14 | 15 | 40/25 篇達標（法說7+Chang訪談11+Wei訪談20+領導層報導2）；逐字稿 **28 篇**已下載至 transcripts/ |
| **小計** | **27.5** | **30** | 含新增繼任風險 4.5/5 分 |

## 延伸維度評分（地緣政治/環境永續/正反論辯）

| 評分項目 | 得分 | 滿分 | 說明 |
|----------|------|------|------|
| 6.1 矽盾正反深入討論+P/E折扣量化+**台灣經濟重要性量化** | 15 | 15 | **新增**：TSMC佔台灣GDP 11.4%（營收）/出口12%/企業所得稅15.9%/勞動力0.72%六維量化表+半導體佔GDP 15-18%+佔出口40-60%+結構性含義分析（Taiwan Insight/Taipei Times/CNBC/Digitimes 6+來源）；矽盾4正4反+P/E折扣量化表+4情境P/E調整+「台灣折價」定義 |
| 6.2 盟友體系+產業依賴度+供應鏈脆弱性+客戶脫鉤分析 | 15 | 15 | Chip 4+JASM/TPD/Quad/AUKUS+盟友戰略含義3重效應+6產業依賴度表+5國家依賴度表+斷供建模$2.7T+**設備供應鏈5大寡佔表**（ASML/AMAT/TEL/Lam/KLA含市佔+制裁替代可行性）+**特殊化學材料4類表**（光阻劑日本佔90%/Shin-Etsu台灣設廠/高純氣體/CMP漿料/矽晶圓）+**TEL-TSMC 2nm IP洩漏事件**（2025-08）+3情境設備替代韌性表+**客戶替代採購7行表**（Apple→Intel 18A-P入門M系列2027/NVIDIA→Samsung Groq 3 LPU+Intel 14A Feynman I/O dies/Broadcom-Tesla-Samsung $165億）+4時間範圍市佔影響表（90%→70-80%最壞/88-92%最佳）+Wei競爭觀+Chang「second source回流」歷史洞察 |
| 6.3 衝突概率+SMIC追趕+中國EUV+ASML斷供+出口管制+**CFIUS+台灣N-2規則** | 15 | 15 | 衝突概率6來源+3層級衝突GDP量化+產業鏈連鎖+複合風險迴路+**SMIC更新至2026-03**（N+3 5nm量產確認/TechInsights Kirin 9030拆解/7nm良率60-70%/5nm良率30-40%/毛利率19.2%/營收$9.3B/十五五規劃放棄70%目標+$700億資金+5優先方向/設備自給率35%/IC自給率19-20%）+中國EUV 4里程碑+CSIS評估+ASML斷供4階段+出口管制量化+**新增CFIUS子節**（4案例表/2024統計/反向CFIUS/CHIPS Act 10年限制）+**新增台灣N-2規則子節**（產業創新條例§22/國安法32項技術/中資限制/首案執法2025-08/N-2戰略張力分析）+台灣民主治理護城河 |
...
| 8.1-8.4 正反論辯+失效條件 | 15 | 15 | Bull 6條+Bear 6條各含數據+7項爭議對比表+**概率加權IRR**（Bull 25%/Base 50%/Bear 20%/Tail 5%→加權~14-15%）+**8.4 失效條件7項**（競爭/需求/地緣x2/財務/技術/環境，每項含門檻值+時間框架+監測來源+當前狀態）+匯總矩陣 |
| **延伸小計** | **75** | **75** | |
...
> **第 2 輪完成（繼任風險+訪談擴充）。新增/重寫**：
> (1) **4.1 繼任風險與板凳深度**（全新章節）——C.C. Wei 年齡 72-73 歲+任期 28 年明確標示；≥2 位次世代領導人完整 profile：**Dr. Y.J. Mii**（EVP Co-COO，UCLA PhD，IEEE Frederik Philips Award，R&D 路線，31 年任期）+ **Y.P. Chyn**（EVP Co-COO，TSMC 創辦元老 39 年，Operations 路線，Golden Spice Modeling 創建者）；4 位副手/支撐高管：Kevin Zhang（SVP Deputy Co-COO，ex-Intel Fellow，55 專利）、Cliff Hou（SVP Deputy Co-COO）、Lora Ho（SVP 策略+ESG）、Wendell Huang（CFO）；板凳深度評級：**中高**（Medium-High）+4 項理由+4 項風險因素（含 2025 年 4 位 SVP 同期離任：Wei-Jen Lo/Rick Cassidy/J.K. Lin/Douglas Yu）；繼任計畫揭露狀態分析（Bloomberg/SCMP 解讀+對標 2012 年 Wei/Liu 模式）
> (2) **訪談清單擴充**：36→40 篇（新增 #37 SIA Awards Speech「No more wafers」、#38 Yahoo Finance「I'm also very nervous」、#39 SCMP Co-COO Succession Move、#40 TrendForce 領導層交替）；逐字稿 23→28 篇（新增 5 篇：CC_Wei_2025_SIA_Awards_Speech / CC_Wei_2026_Yahoo_Nervous_CapEx / TSMC_2024_CoCOO_Succession_Move / TSMC_2025_Leadership_Transition_TrendForce / CC_Wei_2024_CommonWealth_Leadership）
> (3) **評分表更新**：人維度新增「繼任風險與板凳深度」4.5/5 分行；訪談統計更新至 40 篇+28 逐字稿
>
> **第 3 輪完成（地緣政治深化+正反論辯補完）。新增/重寫**：
> (1) **6.3 衝突情境量化深化**——三層級情境 GDP 量化表（緊張-$2,000 億/封鎖-$5.3T/軍事-$10.6T，來源 Insurance Journal 2026 / Bloomberg Economics）+產業鏈連鎖效應 4 項（手機-80%/汽車-190 萬輛/航運$2.45T/AI 歸零）+**複合風險迴路分析**（成長→能源脆弱性→封鎖風險→地緣升級的自我強化迴路）
> (2) **6.3 ASML EUV 斷供情境**（全新子節）——Kill Switch 機制（Bloomberg 報導）+EUV 維護週期（6 個月）+備件庫存（3-6 個月）+**4 階段產能影響模型**（緩衝期→退化期→崩潰期→穩態）+EUV 層數依賴表（N5 14 層/N3 20+/N2 20+）+投資觀點（互相確保破壞威懾）
> (3) **6.3 出口管制最壞情境量化**（全新子節）——中國營收結構拆解表（成熟 60-70%/先進 30-40%）+7nm 禁令毛利稀釋建模（-0.8~1.2pp，重分配後 -0.3~0.5pp）+全面禁令情境（-2~3pp）+產能重分配邏輯（Wei：「demand about three times short of capacity」）
> (4) **6.3 台灣民主治理護城河分析**（全新子節）——制度性智財保護+美國保衛意願的道德論述基礎+政策不確定性風險
> (5) **8.3 IRR 與風險概率矛盾和解**（全新子節）——概率加權 IRR 模型（Bull 25%/Base 50%/Bear 20%/Tail 5%→加權~14-15%）+模型敏感度（Tail 5%→10%：IRR 從 15% 降至 11-12%）
> (6) **8.4 投資論點失效條件**（全新章節）——7 個觸發條件（競爭：Intel 18A 良率 80%/需求：Hyperscaler CapEx -15% QoQ/地緣：72hr 封鎖/財務：毛利 <53% 兩季/技術：N2 良率 <70%/地緣：ASML 對台 EUV 限制/環境：限電限水 >3 月）+每項含門檻值、時間框架、監測來源 URL、當前狀態+匯總矩陣表
> 所有新增內容均附可點擊 URL（Insurance Journal/Bloomberg/Tom's Hardware/Entropy Capital/ResearchGate/Stimson Center/CFR/Congress.gov 等 15+ 來源）。
> 所有新增內容均附可點擊 URL（Wikipedia/SCMP/Bloomberg/Yahoo Finance/TrendForce/Taipei Times/Tom's Hardware 等 12+ 來源）。
>
> **第 4 輪完成（供應鏈脆弱性+客戶脫鉤分析）。新增**：
> (1) **6.2 供應鏈設備與材料集中度脆弱性**（全新子節）——五大設備商寡佔表（ASML/AMAT/TEL/Lam/KLA，含國籍、核心設備、全球市佔、TSMC 依賴度、制裁替代可行性）+特殊化學材料 4 類表（EUV 光阻劑日本佔 90%/Shin-Etsu 台灣雲林設廠+產能擴增 50%/高純氣體/CMP 漿料/矽晶圓 GlobalWafers 本土替代）+2025-08 TEL-TSMC 2nm IP 洩漏事件（6 人逮捕/台灣國安法/AI 驅動 IP 監控系統）+3 情境設備替代韌性表（日本禁運/美國禁運/封鎖海運中斷）+投資觀點（三道防線：盟友體系+本地化+庫存緩衝）
> (2) **6.2 美中科技脫鉤下客戶替代採購選項分析**（全新子節）——7 行客戶替代表：Apple→Intel 18A-P 入門級 M 系列（PDK 0.9.1GA 已取得/2027 量產/15-20% 轉移）、NVIDIA→Samsung Groq 3 LPU（2025 Q3 出貨）+Intel 14A Feynman I/O dies（25% 封裝量/2027-2028）、Broadcom-Tesla-Samsung $165 億合約+3 項結構性限制分析（旗艦仍鎖定 TSMC/良率成本差距/轉換成本 18-24 個月）+4 時間範圍市佔影響表（2026 ~90%→2029-30 最壞 70-80%/最佳 88-92%）+Wei「砸錢買不到競爭力」+Chang「second source 回流 TSMC」歷史洞察+投資觀點（失去低毛利→保留高毛利的結構性優化）
> 所有新增內容均附可點擊 URL（CSIS/ainvest/Digitimes/TrendForce/SemiAnalysis/Fountyl Tech/Gadget Hacks/FinancialContent/WCCFTech 等 15+ 來源）。

**第 5 輪完成（地緣政治維度深化）。新增**：
> (1) **6.1 TSMC 對台灣經濟的系統性重要性——量化實證**（全新子節）——6 行量化表（營收佔 GDP 11.4%/出口 12%/企業所得稅 15.9%/員工 7.3 萬/半導體 GDP 15-18%/CapEx 密度 ~50% 台灣政府預算）
> (2) **6.3 中國反制風險——SMIC 追趕時程與技術差距**（全面更新）——11 行數據表（N+3 5nm 量產確認/良率 5nm 30-40%/7nm 60-70%/SMIC 營收 $9.3B/毛利率 19.2%/7nm ~30K wspm/5nm ~10K wspm/第 15 個五年計劃分析：取消 70% 自給率目標/$700 億資金/5 優先領域/IC 自給率 19-20%/設備自給率 35%）
> (3) **6.3 CFIUS 外資審查、反向 CFIUS 與台灣半導體保護機制**（全新子節）——CFIUS 先例表 4 案（Aixtron 2016/Lattice 2017/Qualcomm 2018/EMCORE-HieFo 2026）+2024 CFIUS 統計+反向 CFIUS 說明+CHIPS Act 附帶條件分析+台灣 N-2 規則表 4 機制（N-2 規則/國安法/中資限制/首次執法 2025-08）+美台戰略張力分析
> 所有新增內容均附可點擊 URL（Taipei Times/Taiwan Insight/CNBC/Digitimes/TSMC ESG Report/GraniteFirm/TechInsights/ChinaTalk/SCMP/Reuters/Treasury.gov/Congress.gov 等 20+ 來源）。

...
| 人 | 23 | 25 | Chang 誠信底線+Wei 格局觀擴充（Yale演講/Intel競爭觀/誠信承諾/Monte Jade）；訪談 36/25 篇+**逐字稿 23 篇** |
| **四維合計** | **91.5** | **100** | 含延伸維度（六七八章）總分 166/175，詳見第五節評分表 |
...
**統計**：已收集 36 篇（法說 7 篇 + Morris Chang 訪談/演講 11 篇 + C.C. Wei 訪談/活動 18 篇）。逐字稿已下載 23 篇至 `transcripts/` 目錄：
...
| 公開訪談 ≥25 篇 + 逐字稿已下載 | 14 | 15 | 36/25 篇達標（法說7+Chang訪談11+Wei訪談18）；逐字稿 **23 篇**已下載至 transcripts/ |
| **小計** | **23** | **25** | |
